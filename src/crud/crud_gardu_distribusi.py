...
def get_gardu(db: Session, gardu: str = None, nama_area: str = None, nama_gi: str = None, limit: int = 10):
    ...
    if nama_gi is not None:
        result = result.filter(models.GarduDistribusi.nama_gi == nama_gi)
    if limit > 0:
