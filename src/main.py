...
@app.get("/gardu-induk", response_model=gardu_induk.AllGardu)
...
@app.get("/gardu-induk/tersedia", response_model=gardu_induk.ReadGarduInduk)
...
@app.get("/gardu-induk/lokasi", response_model=gardu_induk.GarduIndukLocation)
...
@app.get("/gardu-induk/area", response_model=area.ReadArea)
...
@app.get("/gardu-induk/rekomendasi", response_model=load_point.GIRecommendation)
...
@app.get("/gardu-induk/total-beban", response_model=load_point.ReadLoadPoint)
...
@app.get("/gardu-induk/kerapatan-beban", response_model=load_point.ReadLoadDensity)
...
@app.get("/gardu-distribusi", response_model=gardu_distribusi.AllGardu)
...
@app.get("/gardu-distribusi/filter", response_model=gardu_distribusi.GarduList)
...
@app.post("/metode", response_model=calc_method.CalcMethodBase)
